module Constants
  module Rates
    ...
    DEFAULT_EXCHANGE_RATE = 1400 # 하나은행 월요일 09시 송금환율 (2026-05-07)
    ...
    # ============================================================
    DEFAULT_FSC_PERCENT = 47.25 # UPS FSC, effective 2026-05-04
    DEFAULT_FSC_PERCENT_DHL = 47.00 # DHL FSC, effective 2026-05-04
