...
// Market Defaults
export const DEFAULT_EXCHANGE_RATE = 1400; // Manual: 하나은행 월요일 09시 송금환율 (2026-08-10)
...
export const DEFAULT_FSC_PERCENT_DHL = 40.25; // DHL FSC, effective 2026-08-10~08-16
export const DEFAULT_FSC_PERCENT_FEDEX = 46.0; // FedEx FSC, effective 2026-08-10
