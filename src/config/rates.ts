...
// Market Defaults
export const DEFAULT_EXCHANGE_RATE = 1400; // Manual: 하나은행 월요일 09시 송금환율 (2026-05-07)
...
// ============================================================
export const DEFAULT_FSC_PERCENT = 49.5; // UPS FSC, effective 2026-05-18
export const DEFAULT_FSC_PERCENT_DHL = 47.25; // DHL FSC, effective 2026-05-18
